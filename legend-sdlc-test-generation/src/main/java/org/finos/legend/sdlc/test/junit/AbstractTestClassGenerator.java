...
class AbstractTestClassGenerator extends JavaCodeGenerator
{
    ...
    private static final int NAME_BYTE_MAX = 253 - TEST_PREFIX.getBytes(StandardCharsets.UTF_8).length - JavaFileObject.Kind.SOURCE.extension.getBytes(StandardCharsets.UTF_8).length;
